...
export const es: Translations = {
  ...
  endpoints: {
    ...
    subtitle: "OpenAI-compatible providers you added yourself - the picker and Telegram /model can switch to them directly.",
    addButton: "Add endpoint",
    currentlyActive: "Currently active",
    noEndpoints: "No custom endpoints yet",
    noEndpointsHint: "Add an OpenAI-compatible base URL (self-hosted, another gateway, etc.) and its model, then activate it from here or switch in /model.",
    test: "Test",
    testing: "Testing...",
    testOk: "Endpoint responded",
    testFail: "Endpoint failed",
    saveOk: "Saved",
    saveFail: "Save failed",
    loadFail: "Failed to load endpoints",
    activateOk: "Activated",
    ...
    formTitle: "Endpoint",
    formName: "Name",
    formNameHint: "Shown in the picker (e.g. my-gateway)",
    formBaseUrl: "Base URL",
    formBaseUrlHint: "e.g. https://my-gateway.example/v1",
