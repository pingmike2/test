...
export const zh: Translations = {
  ...
  endpoints: {
    title: "自定义端点",
    subtitle: "你自己添加的 OpenAI 兼容提供商 —— 模型选择器和 Telegram 的 /model 都能直接切换到它们。",
    addButton: "添加端点",
    currentlyActive: "当前激活",
    noEndpoints: "还没有自定义端点",
    noEndpointsHint: "添加一个 OpenAI 兼容的 Base URL（自建服务、其他网关等）及其模型，然后在这里激活，或在 /model 中切换。",
    test: "测试",
    testing: "测试中…",
    testOk: "端点响应正常",
    testFail: "端点测试失败",
    ...
    deleteOk: "已删除",
    deleteFail: "删除失败",
    deleteConfirm: "删除这个端点？",
    formTitle: "端点",
    formName: "名称",
    formNameHint: "在选择器中显示（例如 my-gateway）",
    formBaseUrl: "Base URL",
    formBaseUrlHint: "例如 https://my-gateway.example/v1",
    formModel: "默认模型",
    formModels: "模型列表",
    formApiKey: "API 密钥",
